...
import type { Screen, ConversationMessage, StructuredField, OpenAnswer } from "./types";
import { nanoid, formatSize } from "./utils";
import {
  buildStructuredFieldsFromTags,
  validateField,
  extractQuestionSentence,
  isQuestionMessage,
  extractConfirmedFields,
  extractReviewSections,
} from "./parsing";
import { Mark, Spinner } from "./components/icons";
import { WelcomeScreen } from "./components/WelcomeScreen";
import { AuthScreen } from "./components/AuthScreen";
import { AIMessageBubble, CandidateMessageBubble } from "./components/MessageBubbles";
